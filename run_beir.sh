...
python3 benchmark_beir.py --model "Efficient-ML/LLaMA-3-8B-SmoothQuant-8bit-8bit" --quant_method gptq --eval_ppl --epochs 0 --output_dir ./log/beir/LLaMA-3-8B-SmoothQuant-8bit-8bit --wbits 4
