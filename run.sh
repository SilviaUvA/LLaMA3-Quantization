...
# python3 main.py --eval_ppl --model meta-llama/Meta-Llama-3-8B --peft Efficient-ML/LLaMA-3-8B-IR-QLoRA --tau_range 0.1 --tau_n 100 --blocksize 256 --epochs 0 --output_dir ./log/llama-3-8b-irqlora --wbits 4 --tasks winogrande
